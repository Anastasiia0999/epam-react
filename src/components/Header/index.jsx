            ...
            <div className='container'>
                <div className="row">
                    <ul className='card-header header-main col-12 my-3'>
                        {logStatus ?  <li className = 'link-text' onClick={this.handleLogOut}>{fields['logOut-btn']}</li> : <li><BrowserRouter><Link className = 'link-text' to='/login'><h6 className='link-text'>{fields['logIn-btn']}</h6></Link></BrowserRouter></li>}
...
Header.propTypes ={
    ...
    changeLanguageDispatch: PropTypes.func,
}
